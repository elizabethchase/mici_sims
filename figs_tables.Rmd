...
corrplot(testmatrix, is.corr = FALSE, method = 'color', addgrid.col = 'white', addCoef.col = 'grey50', number.digits = 1, col = COL1('Blues', 7), cl.pos = 'n', tl.col = 'black', type = 'lower', col.lim = c(0, 17))
dev.off()
```
